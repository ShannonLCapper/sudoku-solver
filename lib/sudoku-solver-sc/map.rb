...
makes hi fly into an insane rage and blast you repeatedly in the face until
you are dead. Then he eats you.
""")

	DODGE_DEATH = Room.new("Death",
"""
Like a world class boxer, you dodge, weave, slip and slid right
...
""")
	...
	WRONG_CODE_DEATH = Room.new("Death",
"""
After the final buzz, you hear a sickening melting sound as 
the mechanism is fused together. You decide to sit there,
and finally the Gothons blow up the ship from their ship and you die.
""")

	THROW_BOMB_DEATH = Room.new("Death",
"""
...
""")
  ...
  # ESCAPE_POD.paths.default = THE_END_LOSER
  ...
  # LASER_WEAPON_ARMORY.paths.default = WRONG_CODE_DEATH
  ...
  ROOM_NAMES = {
  	...
  	'THROW_BOMB_DEATH' => THROW_BOMB_DEATH,
  ...
  def Map::randomize
  	...
  	code = ""
  	3.times { code += rand(9).to_s }
  	LASER_WEAPON_ARMORY.paths = {code => THE_BRIDGE, '*' => WRONG_CODE_DEATH}

  	pod = rand(1..5).to_s
  	ESCAPE_POD.paths = {pod => THE_END_WINNER, '*' => THE_END_LOSER}
  end
